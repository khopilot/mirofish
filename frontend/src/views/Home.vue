            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g., What public opinion trends would emerge if a university publishes a notice revoking a disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Uses Space Grotesk as the main heading font, JetBrains Mono as the code/label font.
