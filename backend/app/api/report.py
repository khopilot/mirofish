...
def generate_report():
    ...
    try:
        ...
        if not graph_id:
            return jsonify({
                "success": False,
                "error": "Missing graph ID, please ensure a graph has been built"
            }), 400
...
def chat_with_report_agent():
    ...
    Request (JSON):
        {
            "simulation_id": "sim_xxxx",        // Required, simulation ID
            "message": "Please explain the public opinion trends",  // Required, user message
