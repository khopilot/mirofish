...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        # Return directly in "agent name: activity description" format without simulation prefix
...
class ZepGraphMemoryUpdater:
    ...
    Monitor simulation action log files and update new agent activities to Zep graph in real time.
    Group by platform, batch send to Zep after accumulating BATCH_SIZE activities.
    
    All meaningful actions will be updated to Zep, action_args contains full context:
    ...
    # Send interval (seconds), avoid sending too fast
    SEND_INTERVAL = 0.5
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context (e.g., original post text, usernames, etc.).
                ...
                try:
                    ...
                    with self._buffer_lock:
                        ...
                        if len(self._platform_buffers[platform]) >= self.BATCH_SIZE:
                            ...
                            # Send interval, avoid too-fast requests
    ...
    def _send_batch_activities(self, activities: List[AgentActivity], platform: str):
        ...
        # Merge activities into one text, separated by newlines
    ...
    def _flush_remaining(self):
        ...
        # First process remaining queue activities, add to buffer
        ...
        # Then send remaining per-platform buffer activities (even if < BATCH_SIZE)
        with self._buffer_lock:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "batches_sent": self._total_sent,            # Successful batch count
            "items_sent": self._total_items_sent,        # Successful activity count
