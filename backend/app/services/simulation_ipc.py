...
Implements a simple command/response pattern via filesystem:
1. Flask writes commands to the commands/ directory
2. Simulation script polls command directory, executes commands, writes responses to responses/ directory
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: In dual-platform mode interview on both, in single-platform mode interview on that platform
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each item's platform)
                - "twitter": Default: interview only on Twitter
                - "reddit": Default: interview only on Reddit
...
class SimulationIPCServer:
    ...
    Polls command directory, executes commands, returns responses
    """
