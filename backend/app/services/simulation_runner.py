...
# Flag for whether cleanup function is already registered
...
class SimulationRunState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            # Per-platform independent rounds and times
...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        max_rounds: int = None,  # Max simulation rounds (optional, for truncating overly long simulations)
        ...
        Args:
            ...
            max_rounds: Max simulation rounds (optional, for truncating overly long simulations)
        ...
        try:
            ...
            # Create main log file to prevent stdout/stderr pipe buffer full causing process block
    ...
    def _read_action_log(
        ...
        Args:
            ...
            position: Previous read position
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If both platforms ran, both need to complete
                                ...
                                # Update round info (from round_end events)
                                    ...
                                    # Update per-platform independent rounds and times
                                    if platform == "twitter":
    ...
    def _check_all_platforms_completed(cls, state: SimulationRunState) -> bool:
        ...
        Determines if a platform was enabled by checking if its actions.jsonl file exists
        ...
        # Check which platforms were enabled (by file existence)
        twitter_enabled = os.path.exists(twitter_log)
        reddit_enabled = os.path.exists(reddit_log)
        
        # If platform was enabled but not completed, return False
        if twitter_enabled and not state.twitter_completed:
            return False
        if reddit_enabled and not state.reddit_completed:
            return False
        
        # At least one platform was enabled and completed
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        """
        Clean up simulation run logs (for forcing simulation restart)
    ...
    def register_cleanup(cls):
        ...
        # In Flask debug mode, only register cleanup in reloader child process (the actual app process)
        # WERKZEUG_RUN_MAIN=true indicates the reloader child process
        # If not debug mode, this env var does not exist, still needs registration
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Target platform (optional)
                ...
                - None: Interview on both platforms, return integrated results
    ...
    def interview_agents_batch(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each item's platform)
                ...
                - None: Interview each Agent on both platforms
            timeout: Timeout in seconds
    ...
    def get_interview_history(
        ...
        Args:
            ...
            agent_id: Specific Agent ID (optional, get only that Agent's history)
