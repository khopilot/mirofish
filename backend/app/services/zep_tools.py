...
Wraps graph search, node reading, edge queries, etc. for use by Report Agent
...
class InsightForgeResult:
    ...
    Contains retrieval results from multiple sub-queries, plus integrated analysis
    """
    query: str
...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        # Involved entities (full output, no truncation)
        if self.all_nodes:
            text_parts.append(f"\n### [Involved Entities]")
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                # Filter out junk content containing question numbers
                skip = False
                for d in '123456789':
...
class ZepToolsService:
    ...
    def search_graph(
        ...
        Search for related information in the graph using hybrid search (semantic+BM25).
    ...
    def get_all_nodes(self, graph_id: str) -> List[NodeInfo]:
        """
        Get all nodes from the graph (with pagination)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges from the graph (with pagination, including temporal info)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Gets all graph edges, then filters for those related to the specified node
    ...
    def get_simulation_context(
        ...
        Args:
            ...
            limit: Number limit for each type of information
    ...
    def insight_forge(
        ...
        Most powerful hybrid retrieval function, auto-decomposes queries and retrieves across multiple dimensions:
        ...
        # Step 3: Extract related entity UUIDs from edges, get only these entities (not all nodes)
        entity_uuids = set()
    ...
    def _generate_sub_queries(
        ...
        Decomposes complex questions into multiple independently retrievable sub-queries
        """
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        3. Categorize current valid and historical information
        
        This tool is suitable for scenarios that require understanding the full picture and tracking evolution.
    ...
    def interview_agents(
        ...
        4. Calls /api/simulation/interview/batch endpoint for real interviews (dual-platform simultaneously)
        5. Integrates all interview results and generates interview report
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "4. Answer each question by number, starting each with \"Question X:\" (X is the question number)\n"
        ...
        try:
            ...
            # Step 5: Parse API return results, construct AgentInterview objects
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Clean response text: remove markers, numbering, Markdown artifacts
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean JSON tool call wrapping in Agent responses, extract actual content"""
