...
2. Optimized prompts for generating very detailed personas
...
class OasisProfileGenerator:
    ...
    # Group/institution entity types (need representative persona generation)
    GROUP_ENTITY_TYPES = [
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        Zep has no built-in hybrid search interface, so edges and nodes must be searched separately then merged.
    ...
    def _is_group_entity(self, entity_type: str) -> bool:
        """Determine if entity is a group/institution type"""
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media user persona generation expert. Generate detailed, realistic personas for public opinion simulation, maximizing restoration of existing real-world situations. Must return valid JSON format, all string values must not contain unescaped newlines. Use Chinese."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for the entity, maximizing restoration of existing real-world situations.
...
2. persona: Detailed persona description (2000 characters of plain text), must include:
   ...
   - Personal memories (important part of persona, introduce this individual's connection to events, and their existing actions and reactions in events)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for the institution/group entity, maximizing restoration of existing real-world situations.
...
2. persona: Detailed account profile description (2000 characters of plain text), must include:
   ...
   - Content characteristics (content types, publishing frequency, active time periods)
...
- Institutional account speech must match its identity positioning"""
    ...
    def _save_twitter_csv(self, profiles: List[OasisAgentProfile], file_path: str):
        """
        Save Twitter Profile as CSV format (OASIS official requirements)
