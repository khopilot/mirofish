...
class ZepEntityReader:
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        Returns:
            List of nodes
        """
        logger.info(f"Getting graph {graph_id}  all nodes...")
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        Returns:
            List of edges
        """
        logger.info(f"Getting graph {graph_id}  all edges...")
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If a node's Labels only has "Entity"，this entity does not match our predefined types, skip
        ...
        Args:
            ...
            enrich_with_edges: Whether to get each entity's related edge information
